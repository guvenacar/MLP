...
INPUT_FILE="$ROOT_DIR/compiler/stage1-mlp/mlpc.mlp"
BUILD_DIR="$ROOT_DIR/build/bootstrap"
OUTPUT_EXE="$ROOT_DIR/mlpc_bootstrap"

# Tools
FLATTENER="$ROOT_DIR/dev/tools/bootstrap/flatten_imports.py"
SYNTAX_PREP="$ROOT_DIR/compiler/preprocessors/syntax_preprocessor.py"
LANG_PREP="$ROOT_DIR/compiler/preprocessors/mlp_preprocessor.py"
STAGE0_COMPAT="$ROOT_DIR/dev/tools/bootstrap/stage0_compat.py"
COMPILER="$ROOT_DIR/compiler/stage1-mlp/mlp_compiler"

# Runtime Sources (for linking)
RUNTIME_SRCS="$ROOT_DIR/compiler/runtime/src/runtime.c $ROOT_DIR/compiler/runtime/src/hashmap.c $ROOT_DIR/compiler/runtime/src/json_parser.c"

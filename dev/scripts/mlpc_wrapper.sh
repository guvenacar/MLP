...
python3 "$ROOT_DIR/compiler/preprocessors/syntax_preprocessor.py" "$INPUT_FILE" "$TEMP_NORMALIZED"
...
python3 "$ROOT_DIR/compiler/preprocessors/mlp_preprocessor.py" "$TEMP_NORMALIZED" "$TEMP_ENGLISH"

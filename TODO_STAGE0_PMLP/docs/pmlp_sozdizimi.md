...
### 🔤 Temel Syntax (Migration İçin Kritik)
...
- [Fonksiyon Tanımı](#fonksiyon-tanımı) - Temel syntax (satır 317)
- [Varsayılan Değerli Parametreler](#varsayılan-değerli-parametreler-) - `:=` (satır 337)
- [Referans Parametreler](#referans-ve-sabit-parametreler-refconst) - `ref`, `const` (satır 358)
- [Variadic Parametreler](#variadic-parametreler-) - `...` (satır 389)
- [Named Parameters](#named-parameters-i̇simli-parametreler) - `name: value` (satır 415)
- [Output Parametresi](#output-parametresi-out) - `out` (satır 447)

### 📦 Struct ve Enum (Parser/Codegen İçin)
...
- [If-Else-If](#if-else-if) - Koşullar (satır 608)
- [While Döngüsü](#while-döngüsü) - While (satır 620)
- [For Döngüsü](#for-döngüsü) - For (satır 628)
- [For-Each](#for-each-döngüsü) - Iterator (satır 862)
- [Switch-Case](#switch-case) - Switch (satır 636)

### 🚀 Gelişmiş Özellikler (İhtiyaç Varsa)
- [Generic/Template](#generictemplate-parametreler-t) - `<T>` (satır 474)
- [Union Tipi](#unioneither-tipi-) - `numeric | string` (satır 508)
- [Lambda Functions](#lambdaanonymous-functions) - Anonim fonksiyonlar (satır 840)
- [Try-Catch-Finally](#try-catch-finally-hata-yönetimi) - Exception handling (satır 765)
- [Pattern Matching](#matchpattern-matching) - Match (satır 785)
- [Operator Overloading](#operator-overloading) - Özel operatörler (satır 813)
- [Pointer Syntax](#pointer-syntax) - İşaretçiler (satır 746)
- [Null/Nullable](#nullnullable-tipler) - Null handling (satır 915)

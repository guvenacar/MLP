...
// MLP fonksiyon adlarını C runtime fonksiyon adlarına map eder
...
void visit_IslecCagirma(ASTNode* node) {
    ...
    // (Bu fonksiyonlar sadece MLP compiler'ını MLP'de yazmak için gerekli)

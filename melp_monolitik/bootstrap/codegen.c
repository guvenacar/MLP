...
//
// ============================================================================
// MODÜL HARİTASI (Modular Structure Map)
// ============================================================================
// Bu dosya aşağıdaki modüllere ayrılmıştır:
//
// MODÜL                    SATIRLAR        FONKSİYONLAR
// ---------------------------------------------------------------------------
// codegen.h (types)        1-147           Struct tanımları, typedef'ler
// codegen_core.c           148-191,551-564 codegen_create, emit, add_string
// codegen_module.c         192-210         module_seen, mark_module_seen
// codegen_operator.c       212-236         add/find_operator_overload
// codegen_generic.c        237-313         generic_func işlemleri
// codegen_variable.c       316-497         variable management (add/find)
// codegen_type.c           499-549         enum, type_alias
// codegen_function.c       566-586         add/find_function
// codegen_struct.c         588-631         add/find_struct
// codegen_interface.c      642-668         add/find_interface
// codegen_prologue.c       674-834         prologue, epilogue, is_builtin
// codegen_decl.c           836-1130        generate_declaration
// codegen_assign.c         1131-1262       generate_assignment
// codegen_print.c          1264-1386       generate_print + helpers
// codegen_expr.c           1387-2822       generate_expression_value
// codegen_compare.c        2823-2962       generate_comparison
// codegen_if.c             2964-3016       generate_if
// codegen_for.c            3018-3274       generate_for, generate_for_in
// codegen_while.c          3276-3385       generate_while, generate_do_while
// codegen_switch.c         3387-3541       generate_switch
// codegen_funcdef.c        3543-3689       generate_func_def
// codegen_return.c         3691-3768       generate_return
// codegen_stmt.c           3769-4511       generate_statement
// codegen_main.c           4512-4735       codegen_generate (main entry)
// codegen_core.c           4737-4741       codegen_free
// ============================================================================
...
// ============================================================================
// MODÜL: codegen.h (TYPES) - Başlangıç
// Struct tanımları ve typedef'ler
// ============================================================================
...
// ============================================================================
// MODÜL: codegen.h (TYPES) - Bitiş
// ============================================================================

// ============================================================================
// MODÜL: codegen_core.c - Başlangıç
...
// ============================================================================
// MODÜL: codegen_core.c - Bitiş (devamı satır 590'da)
// ============================================================================

// ============================================================================
// MODÜL: codegen_module.c - Başlangıç
...
// ============================================================================
// MODÜL: codegen_module.c - Bitiş
// ============================================================================

// ============================================================================
// MODÜL: codegen_operator.c - Başlangıç
...
// ============================================================================
// MODÜL: codegen_operator.c - Bitiş
// ============================================================================

// ============================================================================
// MODÜL: codegen_generic.c - Başlangıç
...
// ============================================================================
// MODÜL: codegen_generic.c - Bitiş
// ============================================================================

// ============================================================================
// MODÜL: codegen_variable.c - Başlangıç
...
// ============================================================================
// MODÜL: codegen_variable.c - Bitiş
// ============================================================================

// ============================================================================
// MODÜL: codegen_type.c - Başlangıç
...
// ============================================================================
// MODÜL: codegen_type.c sonu
// ============================================================================

// ============================================================================
// MODÜL: codegen_emit.c başlangıcı
...
// ============================================================================
// MODÜL: codegen_emit.c sonu
// ============================================================================

// ============================================================================
// MODÜL: codegen_function.c başlangıcı
// İçerik: codegen_add_function, codegen_find_function
// Fonksiyon bilgilerini yönetir
// ============================================================================
...
// ============================================================================
// MODÜL: codegen_function.c sonu
// ============================================================================

// ============================================================================
// MODÜL: codegen_struct.c başlangıcı
...
// ============================================================================
// MODÜL: codegen_struct.c sonu
// ============================================================================

// ============================================================================
// MODÜL: codegen_interface.c başlangıcı
...
// ============================================================================
// MODÜL: codegen_interface.c sonu
// ============================================================================

// ============================================================================
// MODÜL: codegen_prologue.c başlangıcı
...
// ============================================================================
// MODÜL: codegen_prologue.c sonu
// ============================================================================

// ============================================================================
// MODÜL: codegen_decl.c başlangıcı
...
// ============================================================================
// MODÜL: codegen_decl.c sonu
// ============================================================================

// ============================================================================
// MODÜL: codegen_assign.c başlangıcı
...
// ============================================================================
// MODÜL: codegen_assign.c sonu
// ============================================================================

// ============================================================================
// MODÜL: codegen_print.c başlangıcı
...
// ============================================================================
// MODÜL: codegen_print.c sonu
// ============================================================================

// ============================================================================
// MODÜL: codegen_expr.c başlangıcı
...
// ============================================================================
// MODÜL: codegen_expr.c sonu
// ============================================================================

// ============================================================================
// MODÜL: codegen_compare.c başlangıcı
...
// ============================================================================
// MODÜL: codegen_compare.c sonu
// ============================================================================

// ============================================================================
// MODÜL: codegen_if.c başlangıcı
// İçerik: codegen_generate_if
// if-elseif-else yapılarını işler
// ============================================================================
...
// ============================================================================
// MODÜL: codegen_if.c sonu
// ============================================================================

// ============================================================================
// MODÜL: codegen_for.c başlangıcı
// İçerik: codegen_generate_for, codegen_generate_for_in
// for ve for-in döngülerini işler
// ============================================================================
...
// ============================================================================
// MODÜL: codegen_for.c sonu
// ============================================================================

// ============================================================================
// MODÜL: codegen_while.c başlangıcı
// İçerik: codegen_generate_while, codegen_generate_do_while
// while ve do-while döngülerini işler
// ============================================================================
...
// ============================================================================
// MODÜL: codegen_while.c sonu
// ============================================================================

// ============================================================================
// MODÜL: codegen_switch.c başlangıcı
// İçerik: codegen_generate_switch
// switch-case yapılarını işler
// ============================================================================
...
// ============================================================================
// MODÜL: codegen_switch.c sonu
// ============================================================================

// ============================================================================
// MODÜL: codegen_funcdef.c başlangıcı
...
// ============================================================================
// MODÜL: codegen_funcdef.c sonu
// ============================================================================

// ============================================================================
// MODÜL: codegen_return.c başlangıcı
...
// ============================================================================
// MODÜL: codegen_return.c sonu
// ============================================================================

// ============================================================================
// MODÜL: codegen_stmt.c başlangıcı
...
// ============================================================================
// MODÜL: codegen_stmt.c sonu
// ============================================================================

// ============================================================================
// MODÜL: codegen_main.c başlangıcı
...
// ============================================================================
// MODÜL: codegen_main.c sonu
// ============================================================================
// DOSYA SONU: codegen.c
// Toplam ~5000 satır, 20+ modül
// ============================================================================
